    ...
    <SiteLayout>
      ...
      <div className={style["bg"]}>
        <Container className="my-2">
          <Row className="my-5">
            <Col md={4} className="mt-md-5 mb-auto text-center">
            ...
            <Col md={8}>
              <Card.Body>
                ...
                <Card.Text className={`${style["b"]} mb-4`}>
                  I am a Raleigh, NC based travel agent specializing in planning honeymoons, family gatherings, group travel and destination weddings. My passion is to help you
                  find and experience the most amazing dream vacations. I take the stress out of planning by taking care of all the details so you can relax and enjoy your escape
                ...
                <Card.Text className={`${style["b"]} mt-4`}>
                  ...
                  Association). It is a rigorous program that includes first attaining Accredited Cruise Counselor status, after selling many, many cruises, inspecting and
                  personally sailing on different types of ships. This program enabled me to experience a wide range of cruise brands and gain first hand knowledge so that I can
                  create the perfect experience for my clients.
                </Card.Text>
                <Card.Text className={`${style["b"]} mt-4`}>
                ...
                <Card.Text className={`${style["b"]} mt-4`}>
                  Thank you for taking the time to visit Adjust to the Good Life Travel and considering us for any and all of your vacation planning needs. We are truly grateful
                  for the opportunity to work with you. I love helping my clients discover new and exciting adventures and enjoy building lasting relationships!
                </Card.Text>
                <Card.Text className={`${style["b"]} mt-4`}>
          ...
          <Row className="my-5">
            <Col md={{ span: 4, order: "last" }} className="mt-md-5 mb-auto text-center">
              <Card.Body className={style["image-container"]}>
